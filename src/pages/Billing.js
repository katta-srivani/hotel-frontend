...
function Billing() {
  ...
  useEffect(() => {
    if (!loading && booking) {
      // Navigate to gratitude page without passing booking object
      navigate('/gratitude');
    }
  ...
  return (
    <div className="max-w-xl mx-auto bg-white shadow-lg rounded-2xl p-8 mt-10 text-center">
      ...
      <div className="text-lg font-semibold mb-4 text-blue-700">Hammayya! Your booking is confirmed. Thank you! 😊</div>
